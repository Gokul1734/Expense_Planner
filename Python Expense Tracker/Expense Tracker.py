...
dataentery_frame_bg = '#EDCBD2'
buttons_frame_bg = '#DED4E8'
hlb_btn_bg = '#E8BA40'
frame_bg = "E8BA40"
...
Label(root, text='ATM SIMULATION WITH EXPENSE TRACKER', font=('Noto Sans CJK TC', 15, 'bold'), bg=hlb_btn_bg).pack(side=TOP, fill=X)
